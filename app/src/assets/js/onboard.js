  ...
  $(document).ready(function() {
    ...
    $(".check-errors").click(function() {
      if (fileName == undefined) {
        ...
        $(".file-error").text("source file not slected");

        $(".file-error").addClass("shake");
      }
      ...
      if (directoryName === undefined) {
        ...
        $(".dir-error").text("Destination folder is not selected");

        $(".dir-error").addClass("shake");
      }

      if (directoryName != undefined && fileName != undefined) {
        showloader();

        let checkExcelFile = function() {
          FileCheckstatus = app.passFileNameForLoading(fileName);
          if (FileCheckstatus != undefined) {

            $(".guide-body").addClass("hide");

             console.log(FileCheckstatus);
